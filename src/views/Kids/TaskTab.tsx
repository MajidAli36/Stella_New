...
import { createTaskSchemaKid } from '../../service/ValidationSchema';
...
export default function TaskTab(props: Iprops) {
  ...
  const createform = useForm<NewTaskFormModel>({
    ...
    resolver: yupResolver(createTaskSchemaKid),
    mode: "all"
  });
  ...
  const handleCreateEditTaskSubmit = (event: SyntheticEvent) => {
    ...
    formData.append('houseId', "00000000-0000-0000-0000-000000000000");
      ...
      <Grid className='mb-4' container spacing={5}>
              ...
              <GreyBox>
                ...
                <Box>
                  <GreyBoxHeadingParent>
                    ...
                    <GreyBoxDesc>
                      If there should be an task, try creating one. Otherwise, kick back and relax.
                    </GreyBoxDesc>
                  </GreyBoxHeadingParent>
                </Box>
            ...
            {tasks != undefined && tasks.length > 0 &&
              <>
                ...
                <Stack spacing={2}>
                  ...
                  <Pagination count={Math.ceil((tasks?.length) || 0 / PAGE_SIZE)} page={currentPage} onChange={(event: any, page: number) => { setCurrentPage(page) }} />
        ...
        <Grid item xs={12} md={4} className='h-100'>
          ...
          <div>
            <FormControlLabel
              className='fontsize-11'
              control={<Checkbox onChange={handleHidePrivacyChange} checked={hidePrivate} />}
            ...
            <DrawerBody>
              <div style={{
                ...
                <FormControl variant="standard" fullWidth className="mb-5">
                  ...
                  >
                    <MenuItem key={"kid_incident" + 3} value={kidId}>{kidName}</MenuItem>
