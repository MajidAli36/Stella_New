...
interface FormState {
  values: any; // List of Input Values as string|boolean
  touched?: any; // List of Inputs have been touched as boolean
  errors?: any; // List of Errors for every field as array[] of strings
}
...
export function useAppForm({ validationSchema, initialValues = {} }: UseAppFormParams): UseAppFormReturn {
  ...
  }, [validationSchema, formState.values, formState.touched]);
