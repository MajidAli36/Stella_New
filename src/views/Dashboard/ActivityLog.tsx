...
function ActivityLog(props: Iprops) {
    ...
    const getLogList = () => {
        ...
        //formData.append("kidId", props.kidId???null );
    ...
    const handleRecordingFormSubmit = (event: SyntheticEvent) => {
        ...
        const formData = new FormData();
        const formattedDate = moment(kidRecordingGetValues("date")).format('YYYY-MM-DDTHH:mm:ss');
                                    ...
                                    <div style={{
                                        ...
                                        <Box style={{ display: 'flex', flexDirection: 'column', gap: "4px", width: '100%', marginBottom: "4px" }}>
                                            ...
                                            <Box key="viewfn" style={{ display: 'flex', alignItems: 'center' }}>
                                                ...
                                                <Typography variant="body1">{moment(activityNoteViewModel?.date ?? new Date()).format('YYYY-MM-DDTHH:mm:ss')}
                                                </Typography>
                                            </Box>
                                        </Box>
                                ...
                                <Box>
                                    ...
                                    <DrawerBody>
                                        <div style={{
                                            ...
                                            <InputLabel id="kidIncidentDate" >Date:*</InputLabel>
                                ...
                                <Box>
                                    ...
                                    <DrawerBody>
                                        <div style={{
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', marginBottom: "5px" }}>
                                                <DateTimePicker
                                                    onChange={(event: any) => { incidentRegister("date", event) }}
                                                    format="MM/dd/yyyy HH:mm"
