...
export default function ActivityLogTab(props: Iprops) {
    ...
    React.useEffect(() => {
        if (localStorage.getItem('TabRiskManagement') != null && localStorage.getItem('TabRiskManagement') != '' && localStorage.getItem('TabRiskManagement') != "") {
    ...
    const updateMessage = () => {
        setMessage(''); // Set the new message value here
    };
        ...
        <Box className='d-flex align-items-center justify-content-between'>
            ...
            <GreenTextLabel>
                ...
                <Link
                    ...
                    style={{ cursor: 'pointer', textDecoration: "none", color: "#0AB472" }}
                    to={`/activities/${props.kidId ?? ""}`}
                >
                    View Full Log
                </Link>
                        ...
                        return (
                            ...
                            <Alert style={{ backgroundColor: "#54d5cb" }} severity="success" icon={false} className='d-block mb-3' key={(currentPage - 1) * 2 + index + 1}>
                                <div className='d-flex align-items-center justify-content-between' style={{ overflowY: "auto" }}>
                                    ...
                                    <div>
                                        <Link to="">
                                            <IconButton className='headerIcon' onClick={toggleDrawerEdit(item.id, item.type)}>
